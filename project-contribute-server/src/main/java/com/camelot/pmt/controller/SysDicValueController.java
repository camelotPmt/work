...
public class SysDicValueController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "typeCode", value = "字典类型编码",
                    required = true, paramType = "query", dataType = "String"),
            @ApiImplicitParam(name = "valueName", value = "字典值名称",
                    required = true, paramType = "query", dataType = "String"),
            @ApiImplicitParam(name = "valueCode", value = "字典值编码",
                    required = true, paramType = "query", dataType = "String")})
    public ResponseEntity save(@ApiIgnore SysDictValue sysDictValue) {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "字典值id",
                    required = true, paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "code", value = "字典值编码",
                    required = true, paramType = "query", dataType = "String"),})
    ...
    @ApiImplicitParams(value = {
            ...
            @ApiImplicitParam(name = "valueName", value = "字典名称",
                    paramType = "query", dataType = "String")})
    public ResponseEntity update(@ApiIgnore SysDictValue sysDictValue) {
