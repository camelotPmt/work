...
public class SysDicValueController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "valueName", value = "字典值名称", required = true, paramType =
                    "query", dataType = "String"),
            @ApiImplicitParam(name = "valueCode", value = "字典值编码", required = true, paramType =
                    "query", dataType = "String")})
     ...
     * 删除字典值
     *
     * @param id code 字典值id 编码
     */
    @DeleteMapping(value = "/")
    @ApiOperation(value = "删除字典值", notes = "删除字典值")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "字典值id", required = true, paramType = "query",
                    dataType = "int"),
            @ApiImplicitParam(name = "code", value = "字典值编码", required = true, paramType =
                    "query", dataType = "String"),})
    ...
    @ApiImplicitParams(value = {
            ...
            @ApiImplicitParam(name = "typeCode", value = "字典类型编码", paramType = "query", dataType
                    = "String"),
            @ApiImplicitParam(name = "valueName", value = "字典名称", paramType = "query", dataType =
                    "String")})
