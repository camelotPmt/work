...
public class ExceptionHandle {
    ...
    final ResponseEntity<Object> handleControllerApiException(HttpServletRequest request,
        ...
        if (ex instanceof SQLException) {
            ...
            return new ResponseEntity<>("SQL执行异常：" + sqlException.getMessage(), headers,
                    status);
        }
        ...
        if (ex instanceof IllegalArgumentException) {
            ...
            return new ResponseEntity<>("业务异常：" + illegalArgumentException.getMessage(),
                    headers, status);
        }
        // 捕捉shiro的异常
        ...
        if (ex instanceof UnauthorizedException) {
            ...
            return new ResponseEntity<>("非法授权异常：" + unauthorizedException.getMessage(),
                    headers,
                    HttpStatus.UNAUTHORIZED);
        }
